...
function WindowSidebarProvider({
  defaultOpen = true,
  open: openProp,
...
function WindowSidebar({
  ...
  const { isMobile, state, openMobile, setOpenMobile } = useWindowSidebar();
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-in-out group-data-[resizing=true]:transition-none group-data-[resizing=true]:duration-0",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-in-out group-data-[resizing=true]:transition-none group-data-[resizing=true]:duration-0 md:flex",
          side === "left"
...
function WindowSidebarSeparator({
  className,
  ...props
...
function WindowSidebarGroupContent({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
...
function WindowSidebarMenuItem({
  className,
  ...props
...
const windowSidebarMenuButtonVariants = cva(
...
function WindowSidebarMenuButton({
  ...
  const { currentPageId, setCurrentPageId } = useWindow();
  ...
  const button = (
    <Comp
      ...
      data-size={size}
      data-active={isActive || (to && currentPageId === to)}
      onClick={onClick || (to ? () => setCurrentPageId(to) : undefined)}
      className={cn(
        windowSidebarMenuButtonVariants({ variant, size }),
        className
      )}
      {...props}
    />
...
function WindowSidebarMenuBadge({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
...
function WindowSidebarMenuSubItem({
  className,
  ...props
}: React.ComponentProps<"li">) {
  return (
...
function WindowSidebarMenuSubButton({
  asChild = false,
  size = "md",
  isActive = false,
  className,
...
export {
  ...
  WindowSidebarMenuSub,
  WindowSidebarMenuSubButton,
  WindowSidebarMenuSubItem,
  WindowSidebarProvider,
  WindowSidebarRail,
  WindowSidebarSeparator,
